...
<body>
    <div class="topbar bg-[#006a31] w-full sticky top-0 z-10 ">
        <div class="p-1.5">
    ...
    <div class="fixed popup-sapo bg-green-700 w-12 h-12 rounded-full flex justify-center items-center fill-white"
     style="top: 78%; left: 1.5%"
    >
